  ...
  return (
    <div className="bg-white rounded-lg shadow p-8 text-center">
      <div className="max-w-sm mx-auto">
        ...
        <Link
          href="/add"
          className="inline-flex items-center px-4 py-2 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-[var(--bg-cta)] hover:bg-[var(--bg-cta-hover)] focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[var(--color-blue-500)]"
        >
          Add Post
        </Link>
      </div>
